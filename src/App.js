    ...
    <div className="flex flex-col min-h-screen bg-[#070B15] text-white">
      {showBanner && (
        <div className="bg-[#1E243C] text-sky-200 p-2 flex justify-center items-center text-xs font-light">
          <span>Welcome to Ray! Let's send this shit fam. Coming soon!</span>
      ...
      <div className='w-screen flex justify-between py-4 px-8 bg-[#1E243C] text-sm md:hidden text-slate-500'>
        ...
        <a href="https://x.com/raycatsolana" className='md:hover:text-sky-200 transition ease-in-out duration-150'>
          <div className='flex justify-center'>
        ...
        <a href="https://t.me/raycatonsol" className='md:hover:text-sky-200 transition ease-in-out duration-150'>
          <div className='flex justify-center'>
            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" className='size-6' fill="currentColor" viewBox="0 0 50 50">
